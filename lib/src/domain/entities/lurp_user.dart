...
class LurpUser {
  /// Creates a new [LurpUser] instance.
  LurpUser({
    required this.uid,
  ...
  /// Factory constructor to create an empty [LurpUser] template with optional parameter overrides.
  factory LurpUser.fromEmpty({
    String? uid,
    String? username,
    String? flatUsername,
    String? email,
  ...
  String get fullUrl => '${LurpConfig.baseUrl}/u/$flatUsername';
